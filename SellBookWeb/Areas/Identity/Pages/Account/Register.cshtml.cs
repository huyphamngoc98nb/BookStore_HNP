...
namespace SellBookWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            // Check the database if have the Adminn roles
            ...
            Input = new()
            {
                ...
                CompanyList = _context.Company.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                })
