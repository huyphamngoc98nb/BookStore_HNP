...
namespace SellBook.DataAccess.Migrations
{
    ...
    [Migration("20250128045005_addOrderHeaderAndOrderDetail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SellBook.Models.Models.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SellBook.Models.Models.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SellBook.Models.Models.OrderHeader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SellBook.Models.Models.ShoppingCart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SellBook.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("SellBook.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SellBook.Models.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("SellBook.Models.Models.OrderHeader", b =>
                {
                    b.HasOne("SellBook.Models.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SellBook.Models.Models.ApplicationUser", b =>
                {
                    b.HasOne("SellBook.Models.Models.Company", "Company")
                        .WithMany()
